                ...
                <div class="card-body paidbalance ">
                  <div class="d-flex align-itmes-center">
                    ...
                    <div class="action-balnce">
                      ...
                      <h1><?= c_format($user_totals['user_balance']) ?></h1>
                    </div>
                    <div>
                      <div class="badge bg-primary">
                        <i class="fa-sharp fa-solid fa-arrow-up py-2"></i>
                        <span><?= __('user.paid_balance') ?>  <?= c_format($user_totals['wallet_accept_amount']) ?></span>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="d-flex align-itmes-center">
                    ...
                    <div class="action-balnce">
                      ...
                      <h1><?= (int)$user_totals['click_action_total'] + (int)$user_totals['vendor_action_external_total'] ?>
                        /
                        <?= c_format($user_totals['click_action_commission'] + $user_totals['vendor_action_external_commission']) ?></h1>
                    </div>
                    <div>
                      <div class="badge bg-primary">
                        <i class="fa-solid fa-mobile-retro py-2"></i>
                        <span><?= ($userdetails['is_vendor']) ? __('user.vendor_pay') : '' ?> <?= ($userdetails['is_vendor']) ? c_format($user_totals['vendor_action_external_commission_pay']) : '' ?></span>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="d-flex align-itmes-center">
                    ...
                    <div class="action-balnce">
                      ...
                      <h1><?= (int)($user_totals['total_clicks_count']) ?>
                       /
                       <?= c_format($user_totals['total_clicks_commission']) ?></h1>
                    </div>
                    <div>
                      <div class="badge bg-primary">
                        <i class="fa-sharp fa-solid fa-arrow-up py-2"></i>
                        <span><?= ($userdetails['is_vendor']) ? __('user.vendor_pay') : '' ?> <?= ($userdetails['is_vendor']) ? c_format(
                    ...
                    <div class="card-body">
                      <div class="d-flex align-itmes-center justify-content-between flex-wrap  mb-4">
                        <div class="d-flex align-itmes-center me-0 me-md-4">
                          ...
                          <div class="ms-1">
                            <h5><?= c_format($user_totals['vendor_order_external_total']) ?></h5>
                        ...
                        <div class="d-flex align-itmes-center">
                          ...
                          <div class="ms-1">
                            <h5><?= c_format($user_totals['vendor_sale_localstore_total'])?></h5>
                      ...
                      <div class="mb-4">
                        <div class="d-flex justify-content-between flex-wrap">
                          <h2 class="mb-2"><?= c_format($user_totals['vendor_sale_localstore_total'] + $user_totals['vendor_order_external_total']) ?></h2>
                        </div>
                            ...
                            <div class="modal-dialog modal-dialog-centered  scanner">
                              <div class="modal-content ">
                                ...
                                <div class="modal-footer">
                                  <button type="button" class="btn btn-secondary text-center" data-bs-dismiss="modal"><?= __('user.close') ?></button>
                                </div>
                              </div>
                            </div>
                          </div>
                  ...
                  if($store['status'] || $refer_status){
                    ...
                    <div class="card-body">
                      ...
                      <?php if(($store['status'])){
                        ...
                        <?php if($wallet >= $site_wallet['wallet_unlock_amount_affiliate']) {?>
                                  <div class=" border-custom show-mega-link d-none<?php if($invitationlinkid==0) { echo 'd-none';} ?>" >
                                      <div class="form-group">
                                          <label class="form-label"><?= __('user.affiliate_store_url') ?></label>
