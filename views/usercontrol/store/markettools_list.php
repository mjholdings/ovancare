        ...
        <div class="accordion-item <?= $display_class ?>">
            <div class="accordion-header" id="headingOne">
                <div class="market-heade">
                    <ul>
                        <li>
                            <img class="accordion-image" src="<?php echo base_url($product['fevi_icon']) ?>"
                                 alt="Open Cart">
                        </li>
                        <li class="name-text">
                            <h6><?= $product['title'] ?>
                        ...
                        <li>
                            ...
                            <div class="flex align-items-center list-user-action show-tiny-link">
                                ...
                                <input readonly="readonly" value="<?= $shareUrl ?>" placeholder="<?= $shareUrl ?>"
                                       class="form-control input-form-url-<?= $product['form_id'] ?>">

                                <a class="bt-all btn-warning" copyToClipboard="<?= $shareUrl ?>"
                                   href="javascript:void(0);" data-bs-toggle="tooltip" title="<?= __('user.copied') ?>">
                        <span class="btn-inner">
                          <i class="far fa-copy"></i>
                        </span>
                                </a>

                                <a class="bt-all btn-danger  btn-model-slug" data-type="form"
                                   data-related-id="<?= $product['form_id'] ?>"
                                   data-input-class="input-form-url-<?= $product['form_id'] ?>"
                                   href="javascript:void(0);" data-bs-toggle="tooltip"
                                   title="<?= __('user.slug_settings') ?>">
                          <span class="btn-inner">
                            <i class="fas fa-cog"></i>
                                ...
                                <a class="bt-all btn-dark btn-group-markettools" target='_black'
                                   href="<?= $product['public_page'] ?>">
                        <span class="btn-inner">
                          <i class="fa-solid fa-info"></i>
                        </span>
                                </a>

                                <a class="bt-all btn-success btn-group-markettools"
                                   onclick="generateCodeForm(<?php echo $product['form_id']; ?>,this);"
                        ...
                        <span class="btn-inner">
                            <i class="fa-solid fa-code"></i>
                                ...
                                <a class="bt-all btn-danger get-downloads btn-group-markettools"
                                   href="javascript:void(0)"
                                   onclick="downloadCode(this, <?= $product['form_id'] ?>, 'form')"
                                   data-bs-toggle="tooltip" title="<?= __('user.download_cam_pack') ?>">
                    <span class="btn-inner">
                      <i class="fa-solid fa-download"></i>
                                ...
                                <a class="bt-all btn-secondary btn-group-markettools qrcode" href="javascript:void(0)"
                                   data-id="<?= $shareUrl ?>">
                        <span class="btn-inner" data-bs-toggle="tooltip" title="<?= __('user.qrcode') ?>">
                          <i class="fas fa-walkie-talkie"></i>
                                ...
                                <a href="javascript:void(0);" class="bt-all btn-success" data-social-share
                                   data-share-url="<?= $shareUrl ?>" data-share-title="<?= $product['title']; ?>"
                                   data-share-desc="<?= $product['description']; ?>" data-bs-toggle="tooltip"
                                   title="<?= __('user.share_campaign') ?>">
                        <span class="ms-1">
                            ...
                            <div class="flex align-items-center list-user-action show-mega-link d-none">
                                ...
                                <input readonly="readonly" value="<?= $shareUrl ?>?id=<?= $userdetails['id'] ?>"
                                       placeholder="<?= $shareUrl ?>"
                                       class="form-control input-form-url-<?= $product['form_id'] ?>"
                                       data-addition-url="?id=<?= $userdetails['id'] ?>">


                                <a class="bt-all btn-warning"
                                   copyToClipboard="<?= $shareUrl ?>?id=<?= $userdetails['id'] ?>"
                                   href="javascript:void(0);" data-bs-toggle="tooltip" title="<?= __('user.copied') ?>">
                        <span class="btn-inner">
                          <i class="far fa-copy"></i>
                        </span>
                      ...
                      <span class="btn-inner">
                        <i class="fa-solid fa-download"></i>
                                ...
                                <a class="bt-all btn-secondary btn-group-markettools qrcode" href="javascript:void(0)"
                                   data-id="<?= $shareUrl ?>" data-bs-toggle="tooltip" title="<?= __('user.qrcode') ?>">
                          <span class="btn-inner">
                              <i class="fas fa-walkie-talkie"></i>
                          </span>
                                </a>
                ...
                <span class="accordion-button" role="button" data-bs-toggle="collapse"
                    ...
                    <ul class=" d-flex align-items-center justify-content-between">
                        <li>
                            <div class="item-counting">
                                <p>
                                    <strong><?= __('admin.coupon_code'); ?>
                                        : </strong><?= $product['coupon_code'] ? $product['coupon_code'] : __('user.n_a') ?>
                                </p>
                            </div>
                        </li>
                        <li>
                            <div class="item-counting">
                                <p>
                                    <strong><?= __('admin.coupon_use'); ?>
                                        : </strong><?= ($product['coupon_name'] ? $product['coupon_name'] : '-') . ' / ' . $product['count_coupon'] ?>
                                </p>
                            </div>
                        </li>
                        <li>
                            <div class="item-counting">
                                <p>
                                    <strong><?= __('admin.sales_commission'); ?>
                                        : </strong><?= (int)$product['count_commission'] . ' / ' . c_format($product['total_commission']) ?>
                                </p>
                            </div>
                        </li>
                        <li>
                            <div class="item-counting ">
                                <p>
                                    <strong><?= __('admin.clicks_commission'); ?>
                                        : </strong><?= (int)$product['commition_click_count'] . ' / ' . c_format($product['commition_click']); ?>
                                </p>
                            </div>
                        </li>
                        <li>
                            <div class="item-counting bg-green">
                                <p>
                                    <strong><?= __('admin.total_commission'); ?>
                                        :</strong> <?= c_format($product['total_commission'] + $product['commition_click']); ?>
                                </p>
                            </div>
                        </li>
                    </ul>
                    ...
                    <ul>
                        <li>
                            <img class="accordion-image"
                                 src="<?php echo base_url('assets/images/product/upload/thumb/' . $product['product_featured_image']) ?>"
                                 alt="Open Cart">
                        </li>
                        <li class="name-text">
                        ...
                        <span class="btn-inner">
                          <i class="far fa-copy"></i>
                                    ...
                                    <a class="bt-all btn-danger  btn-model-slug" data-type="product"
                                       data-related-id="<?= $product['product_id'] ?>"
                                       data-input-class="input-product-url-<?= $product['product_id'] ?>"
                                       href="javascript:void(0);" data-bs-toggle="tooltip"
                                       title="<?= __('user.slug_settings') ?>">
                        <span class="btn-inner">
                          <i class="fas fa-cog"></i>
                        ...
                        <span class="btn-inner">
                          <i class="fa-solid fa-info"></i>
                                ...
                                <a class="bt-all btn-success btn-group-markettools"
                                   onclick="generateCode(<?php echo $product['product_id']; ?>,this);"
                                   href="javascript:void(0);">
                        <span class="btn-inner">
                          <i class="fa-solid fa-code"></i>
                        </span>
                                ...
                                <a class="bt-all btn-danger get-downloads btn-group-markettools"
                                   href="javascript:void(0)"
                                   onclick="downloadCode(this, <?= $product['product_id'] ?>, 'form')"
                                   data-bs-toggle="tooltip" title="<?= __('user.download_cam_pack') ?>">
                        <span class="btn-inner">
                          <i class="fa-solid fa-download"></i>
                        </span>
                                ...
                                <?php if ($wallet >= $site_wallet['wallet_unlock_amount_affiliate']) { ?>
                                    <a class="bt-all btn-secondary btn-group-markettools qrcode"
                                       href="javascript:void(0)" data-id="<?= $shareUrl ?>" data-bs-toggle="tooltip"
                                       title="<?= __('user.qrcode') ?>">
                        ...
                        <span class="btn-inner">
                          <i class="fas fa-walkie-talkie"></i>
                                ...
                                <?php } ?>
                                <a href="javascript:void(0);" class="bt-all btn-success" data-social-share
                                   data-share-url="<?= $shareUrl ?>" data-share-title="<?= $product['product_name']; ?>"
                                   data-share-desc="<?= $product['product_short_description']; ?>"
                                   data-bs-toggle="tooltip" title="<?= __('user.share_campaign') ?>">
                        <span class="ms-1">
                          <i class="fa-solid fa-share-from-square"></i>
                        </span>
                                </a>
                            ...
                            <div class="flex align-items-center list-user-action show-mega-link d-none">
                                ...
                                <?php if ($wallet >= $site_wallet['wallet_unlock_amount_affiliate']) { ?>
                                    <input readonly="readonly" value="<?= $shareUrl ?>?id=<?= $userdetails['id'] ?>"
                                           placeholder="<?= $shareUrl ?>"
                                           class="form-control input-form-url-<?= $product['product_id'] ?>"
                                           data-addition-url="?id=<?= $userdetails['id'] ?>">
                        ...
                        <span class="btn-inner">
                          <i class="far fa-copy"></i>
                                    ...
                                    <a class="bt-all btn-danger btn-model-slug" data-type="product"
                                       data-related-id="<?= $product['product_id'] ?>"
                                       data-input-class="input-form-url-<?= $product['product_id'] ?>"
                                       href="javascript:void(0);" data-bs-toggle="tooltip"
                                       title="<?= __('user.slug_settings') ?>">
                        <span class="btn-inner">
                          <i class="fas fa-cog"></i>
                ...
                <div class="accordion-body counting-box">
                    <ul class=" d-flex align-items-center justify-content-between">
                        <li>
                            <div class="item-counting">
                                <p>
                                    <strong><?= __('admin.price') ?>
                                        : </strong><?php echo c_format($product['product_price']); ?>
                                </p>
                            </div>
                        </li>
                        <li>
                        ...
                        <li>
                            <div class="item-counting">
                                <p>
                                    <strong><?= __('admin.sales_/_commission') ?>
                                        : </strong><?php echo $product['order_count']; ?> /
                        ...
                        <li>
                            <div class="item-counting ">
                                <p>
                                    <strong><?= __('admin.clicks_/_commission') ?>
                                        : </strong><?php echo (int)$product['commition_click_count']; ?>
                        ...
                        <li>
                            <div class="item-counting ">
                                <p>
                                    <strong><?= __('admin.display') ?>
                                        : </strong><?= $product['on_store'] == '1' ? __('user.yes') : __('user.no') ?>
                                </p>
                            </div>
                        </li>
                        ...
                        <li>
                            <div class="item-counting bg-green">
                                <p>
                                    <strong><?= __('admin.total') ?>
                                        :</strong> <?php echo c_format((float)$product['commition_click'] + (float)$product['commission']); ?>
                                </p>
                            </div>
                        </li>
                    </ul>
            ...
            <div class="accordion-header" id="headingOne">
                <div class="market-heade">
                    <ul>
                        <li>
                            <img class="accordion-image"
                                 src="<?php echo base_url('assets/images/product/upload/thumb/' . $product['featured_image']) ?>"
                                 alt="Open Cart">
                        </li>
                        <li class="name-text">
                            <h6><?= $product['name'] ?>
                        ...
                        <li>
                            ...
                            <div class="flex align-items-center list-user-action show-tiny-link">
                                ...
                                <input readonly="readonly" value="<?= $shareUrl ?>" placeholder="<?= $shareUrl ?>"
                                       class="form-control input-<?= $product['_tool_type'] ?>-url-<?= $product['id'] ?>">
                        ...
                        <span class="btn-inner">
                          <i class="far fa-copy"></i>
                                ...
                                <a class="bt-all btn-danger  btn-model-slug" data-type="<?= $product['_tool_type'] ?>"
                                   data-related-id="<?= $product['id'] ?>"
                                   data-input-class="input-<?= $product['_tool_type'] ?>-url-<?= $product['id'] ?>"
                                   href="javascript:void(0);" data-bs-toggle="tooltip"
                                   title="<?= __('user.slug_settings') ?>">
                        <span class="btn-inner">
                          <i class="fas fa-cog"></i>
                                ...
                                <a class="bt-all btn-dark btn-group-markettools get-terms"
                                   data-id="<?= $product['id'] ?>" href="javascript:void(0);" data-bs-toggle="tooltip"
                                   title="<?= __('user.terms') ?>">
                        <span class="btn-inner">
                          <i class="fa-solid fa-info"></i>
                        </span>
                                ...
                                <a class="bt-all btn-success btn-group-markettools get-code"
                                   data-id="<?= $product['id'] ?>" href="javascript:void(0);" data-bs-toggle="tooltip"
                                   title="<?= __('user.get_code') ?>">
                        <span class="btn-inner">
                          <i class="fa-solid fa-code"></i>
                        </span>
                                ...
                                <a class="bt-all btn-danger get-downloads btn-group-markettools"
                                   href="javascript:void(0)" onclick="downloadCode(this, <?= $product['id'] ?>, 'tool')"
                                   data-bs-toggle="tooltip" title="<?= __('user.download_cam_pack') ?>">
                        ...
                        <span class="btn-inner">
                          <i class="fas fa-walkie-talkie"></i>
                                ...
                                <a href="javascript:void(0);" class="bt-all btn-success" data-social-share
                                   data-share-url="<?= $shareUrl ?>" data-share-title="<?= $product['name']; ?>"
                                   data-bs-toggle="tooltip" title="<?= __('user.share_campaign') ?>"
                                   data-bs-toggle="tooltip" title="<?= __('user.share_campaign') ?>">
                        <span class="ms-1">
                          <i class="fa-solid fa-share-from-square"></i>
                        ...
                        <span class="btn-inner">
                          <i class="fas fa-cog"></i>
                                ...
                                <a class="bt-all btn-dark get-terms btn-group-markettools"
                                   data-id="<?= $product['id'] ?>" href="javascript:void(0);" data-bs-toggle="tooltip"
                                   title="<?= __('user.terms') ?>">
                        <span class="btn-inner">
                          <i class="fa-solid fa-info"></i>
                    ...
                    <ul class=" d-flex align-items-center justify-content-between">
                        ...
                        if ($product['_tool_type'] == 'program' && $product['sale_status']) { ?>
                            <li>
                                <div class="item-counting">
                                    <p>
                                        <strong><?= __('user.sale_count') ?>
                                            : </strong><?php echo (int)$product['total_sale_count']; ?>
                                    </p>
                                </div>
                            </li>
                            <li>
                                <div class="item-counting">
                                    <p>
                                        <strong><?= __('user.sale_amount') ?>
                                            : </strong><?php echo c_format((int)$product['total_sale_amount']); ?>
                                    </p>
                                </div>
                            </li>
                        <?php }
                        if ($product['_tool_type'] == 'program' && $product['click_status']) { ?>
                            <li>
                                <div class="item-counting">
                                    <p>
                                        <strong><?= __('user.click_count') ?>
                                            : </strong><?php echo (int)$product['total_click_count']; ?>
                                    </p>
                                </div>
                            </li>
                            <li>
                                <div class="item-counting bg-green">
                                    <p>
                                        <strong><?= __('user.click_amount') ?>
                                            : </strong><?php echo (int)$product['total_click_amount']; ?>
                                    </p>
                                </div>
                            </li>
                        <?php }
                        if ($product['_tool_type'] == 'general_click') { ?>
                            <li>
                                <div class="item-counting ">
                                    <p>
                                        <strong><?= __('user.general_count') ?>
                                            : </strong><?php echo (int)$product['total_general_click_count']; ?>
                                    </p>
                                </div>
                            </li>
                            <li>
                                <div class="item-counting bg-green">
                                    <p>
                                        <strong><?= __('user.general_amount') ?>
                                            : </strong><?php echo $product['total_general_click_amount']; ?>
                                    </p>
                                </div>
                            </li>
                        <?php }
                        if ($product['_tool_type'] == 'action' || $product['_tool_type'] == 'single_action') { ?>
                            <li>
                                <div class="item-counting ">
                                    <p>
                                        <strong><?= __('user.action_count') ?>
                                            : </strong><?= (int)$product['total_action_click_count'] ?>
                                    </p>
                                </div>
                            </li>
                            ...
                            <li>
                                <div class="item-counting bg-green">
                                    <p>
                                        <strong><?= __('user.action_amount') ?>
                                            :</strong> <?= $product['total_action_click_amount']; ?>
                                    </p>
                                </div>
                            </li>
                        <?php }
