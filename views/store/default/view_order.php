    ...
    <div class="">
        <div class="container main-container">
	        ...
	        <div class="row non-flex">
	            <h3 class=""><?= __('store.product_info') ?></h3>
	        ...
	        <!--order payment info-->
	        <div class="row non-flex">
	            <h3 class=""><?= __('store.order_payment_info') ?></h3>
	        ...
	        <div class="row non-flex dark-text">
	            <h3 class=""><?= __('store.shipping_details') ?></h3>
	            <div class="table-responsive-lg">
	                <table class="table table-striped">
	                    <thead class="thead-dark">
	                        <tr>
	        ...
	        <?php if($order['files']){ ?>
	        <div class="row non-flex">
	            <h3 class=""><?= __('store.order_attechments_download') ?></h3>
	            <div class="table-responsive-lg">
	                <table class="table table-striped">
	                    <thead class="thead-dark">
	                        <tr>
	        ...
	        <!--order status-->
	        <div class="row non-flex">
	            <h3 class=""><?= __('store.update_order_status') ?></h3>
	            <div class="table-responsive-lg">
	                <table class="table table-striped">
	                    <thead class="thead-dark">
	                        <tr>
