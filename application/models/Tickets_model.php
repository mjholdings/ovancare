...
function set_tickets_admin_action($id){
	...
	$html = '<a href="'.$url.'" title="Click to View ticket" class="edit btn btn-primary btn-sm m-1"><i class="fa fa-eye"></i></a><a data-id="'.$id.'" title="Click to Delete ticket" class="btnremove btn btn-danger btn-sm text-white m-1"><i class="fa fa-trash"></i></a>';
	return $html;
}
