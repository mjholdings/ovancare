<div class="content-body">
    <div class="card award-level">
        <div class="card-header bg-secondary text-white d-flex justify-content-between">
            <h5><?= __('Sửa thông tin chi nhánh') ?></h5>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3"> <label class="form-label">
                            ...
                            <div class="input-group">
                                ...
                                <input value="<?= $branch['con_revenue_branch'] ?>" type="number" class="form-control" name="con_revenue_branch" min="0" step="0.01" placeholder="<?= __('Nhập doanh thu chi nhánh yêu cầu') ?>">
                            </div>
                            <p class="error-message"></p>
                        </div>
                        <div class="col-md-6 mb-3"> <label class="form-label">
                            ...
                            <div class="input-group">
                                <span class="input-group-text refer-reg-symball"><?= $CurrencySymbol ?></span>
                                <input value="<?= $branch['con_revenue_branch_total'] ?>" type="number" class="form-control" name="con_revenue_branch_total" min="0" step="0.01" placeholder="<?= __('Nhập tổng doanh thu nhánh yêu cầu') ?>">
                            </div>
                            <p class="error-message"></p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input value="<?= $branch['sale_commission_rate'] ?>" type="number" class="form-control" name="sale_commission_rate" min="0" step="0.01" placeholder="<?= __('Thưởng Hoa hồng') ?>">
                            </div>
                            <p class="error-message"></p>
                        </div>
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input value="<?= $branch['sale_commission_fixed'] ?>" type="number" class="form-control" name="sale_commission_fixed" min="0" step="1" placeholder="<?= __('Thưởng cứng') ?>">
                            </div>
                            <p class="error-message"></p>
                        </div>
                    </div>
