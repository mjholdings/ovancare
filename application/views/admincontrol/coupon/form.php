                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                   ...
                                   <select class="form-select" name="categories">
                                       ...
                                       <option value="hang-hoa" <?php echo ($coupon['categories'] == 'hang-hoa') ? 'selected' : ''; ?>>Hàng Hóa</option>
                                ...
                                <div class="mb-3">
                                    <label class="form-label"><?= __('Giá trị tối thiểu của sản phẩm') ?></label>
                                    <input type="number" class="form-control" name="total_amount" value="<?= $coupon['total_amount'] ?>">
                                </div>
                                <div class="mb-3">
