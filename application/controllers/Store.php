                ...
                foreach ($products as $key => $product) {
                    ...
                    if ($product['admin_commission'] > 0 && $vendors['admin_sale_status'] == 1) {
                        $comission_data_batch[] = array(
                            ...
                            'comment' => 'Admin trả hoa hồng cho Order Id order_id=' . $order_id . ' | Order By : ' . $order_info['firstname'] . " " . $order_info['lastname'] . " <br> Sale done from ip_message",
                    ...
                    if ($product['vendor_commission'] > 0 && !in_array($product['vendor_id'], $restricted_vendors)) {
                        $comission_data_batch[] = array(
                            ...
                            'comment' => 'NCC hưởng hoa hồng bán hàng cho Order Id order_id=' . $order_id . ' | Order By : ' . $order_info['firstname'] . " " . $order_info['lastname'] . " <br> Sale done from ip_message",
